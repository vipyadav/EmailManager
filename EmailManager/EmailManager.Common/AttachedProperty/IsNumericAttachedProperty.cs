...
namespace EmailManager.Common.AttachedProperty
{
    public static class IsNumericAttachedProperty
    {
        #region IsNumericOnly

        /// <summary>
        /// Provides the ability to restrict the text input of the TextBox control
        /// to only allow numeric values to be entered.
        /// </summary>
        public static readonly DependencyProperty IsNumericOnlyProperty = 
                                DependencyProperty.RegisterAttached("IsNumericOnly", typeof(bool),
                                    typeof(IsNumericAttachedProperty), new UIPropertyMetadata(default(bool), OnIsNumericOnlyChanged));
        ...
        /// <summary>
        /// Adds key listening event handlers to the TextBox object to prevent non numeric key strokes from being accepted
        /// if the IsNumericOnly property value is true, or removes them otherwise.
        /// </summary>
        ...
        public static void OnIsNumericOnlyChanged(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            ...
            if (textBox != null)
            {
                ...
                TextCompositionEventHandler textBox_PreviewTextInput = new TextCompositionEventHandler(
                                                                        (s, e) => e.Handled = !e.Text.All(c => Char.IsNumber(c) && c != ' '));
